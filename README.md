...
<img width="400" height="600" alt="ChatGPT Image Mar 5, 2026, 01_00_08 PM" src="https://github.com/user-attachments/assets/d5d717c4-fecb-46cf-86eb-eefabb318f13" />
...
## Demo 1 - Email Function

Project Captain includes an **Email Function** that allows the agent to send emails within the organization. In the demo, this capability is used to automatically send a **new joiner onboarding plan** generated by the system.

After creating a structured onboarding roadmap based on internal project data (Jira, sprint summaries, ERD documentation, and project documentation), Project Captain sends the onboarding plan directly to the new team member via email.

This demonstrates how the agent can go beyond answering questions and **execute real operational tasks**, helping teams onboard new members faster and reducing manual coordination.

https://github.com/user-attachments/assets/58cc305d-7542-447b-8111-c332e8326d0f

## Demo 2 – Project Knowledge Query

In this demo, users interact with Project Captain by asking natural language questions about the project’s internal data model, sprint activity, and documentation.

Project Captain retrieves information from internal sources such as **ERD/schema documentation, Jira issues, sprint summaries, and approved project documentation** to generate accurate, traceable responses.

For example, a user can ask:

> "What is the Agent ID data field?"

Project Captain will:
1. Retrieve the definition from the ERD documentation.
2. Identify the table where the field is defined.
3. Provide ownership and implementation context if available.
4. Clearly attribute the source of the information.

This demonstrates how Project Captain enables team members to quickly understand project data structures and definitions without needing to manually search across multiple project documents.

https://github.com/user-attachments/assets/a1f97c3c-5a50-4fc9-9929-e3909aa5cff2

## Demo 3 – New Joiner Guide

In this demo, Project Captain helps a new team member quickly understand the project and get started with their work.

When a user indicates that they are a **new joiner**, Project Captain first asks for the user's role (Developer, Business Analyst, or Project Manager). Based on the role, the system retrieves relevant information from internal sources such as **Project Overview, Jira issues, sprint summaries, ERD documentation, and team ownership records**.

Using this information, Project Captain generates a **structured onboarding plan**, outlining what the new joiner should review during their first few days on the project. This may include key data fields, recent sprint changes, important documentation, and relevant team contacts.

The generated onboarding guide helps new team members understand the project faster, reducing dependency on subject matter experts and minimizing the time spent searching across multiple systems.

https://github.com/user-attachments/assets/9c1483e7-6ef4-4101-a4c1-856abc86618c
